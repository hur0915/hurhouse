...
import cn.hur.learn.message.resp.Music;
import cn.hur.learn.pojo.SNSUserInfo;
import cn.hur.learn.pojo.WeixinGroup;
import cn.hur.learn.pojo.WeixinMedia;
import cn.hur.learn.pojo.WeixinOauth2Token;
import cn.hur.learn.pojo.WeixinQRCode;
import cn.hur.learn.pojo.WeixinUserInfo;
import cn.hur.learn.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static String getQRCode(String ticket, String savePath) {
		...
		requestUrl = requestUrl.replace("TICKET", CommonUtil.urlEncode(ticket,"utf-8"));
		try {
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wxfddda94c92627e17", "2664a5cc1961fe3e60950eae5e560503").getAccessToken();

		/**
		 * 发送客服消息（文本消息）
		 */
		// 组装文本客服消息
		String jsonTextMsg = makeTextCustomMessage("oml99wDYCHz9pQE9_d7C29F4uXJ4", "点击查看<a href=\"http://blog.csdn.net/lyq8479\">柳峰的博客</a>");
		// 发送客服消息
		...
		list.add(article2);
		// 组装图文客服消息
		String jsonNewsMsg = makeNewsCustomMessage("oml99wDYCHz9pQE9_d7C29F4uXJ4", list);
		// 发送客服消息
...
//		getQRCode(ticket, savePath);
		 ...
		 * 获取用户信息
		 */
		WeixinUserInfo user = getUserInfo(accessToken, "oml99wDYCHz9pQE9_d7C29F4uXJ4");
		 ...
		 * 移动用户分组
		 */
		updateMemberGroup(accessToken, "oml99wDYCHz9pQE9_d7C29F4uXJ4", 100);

		/**
		 * 上传多媒体文件
		 */
//		WeixinMedia weixinMedia = uploadMedia(accessToken, "image", "http://localhost:8080/learn/flower.jpg");
